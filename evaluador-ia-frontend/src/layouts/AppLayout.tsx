...
export default function AppLayout() {
  ...
  const isDocente = user?.rol === 'docente' || user?.rol === 'admin';
      ...
      <div className="grid grid-cols-[220px_1fr] h-[calc(100vh-73px)]">
        <aside className="bg-slate-800 p-4 border-r border-slate-700">
          ...
          <nav className="space-y-2">
            ...
            {/* Nueva sección solo visible para docentes */}
            {isDocente && (
              <>
                ...
                <NavLink to="/docente/generar-evaluacion" className={linkClass}>
                  <span>Generar Evaluación</span>
                </NavLink>

                <NavLink to="/docente/evaluaciones" className={linkClass}>
